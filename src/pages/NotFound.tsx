...
export default function NotFound() {
  ...
  <div className='flex flex-col items-start justify-center h-[600px]'>
    ...
    <button className='flex flex-row items-center justify-center bg-foreground py-1 w-[200px] rounded-[10px] my-2 border-borders border-[1px] '>
      <img src={Return} alt="뒤로가기" />
      <h5 className='ml-3'>뒤로가기</h5>
    </button>
    <button className='flex flex-row bg-Accent items-center justify-center rounded-[10px] text-white py-1 w-[300px] hover:opacity-70'>
